...
| --- | --- | --- | --- |
| `get_me` `RO` | — | `{id, display_name, uri, external_urls, images}` | `GET /me` |
...
| `get_top_items` `RO` | `type: "artists"\|"tracks"`, `time_range: "short_term"\|"medium_term"\|"long_term"`, `limit≤50`, `offset` | `{items[], total, limit, offset}` | `GET /me/top/{type}` |
